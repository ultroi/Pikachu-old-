...
@user_admin
@loggable
def admin_promote(update: Update, context: CallbackContext) -> str:
    bot = context.bot
    args = context.args
    ...
    bot.sendMessage(
        chat.id,
        f"Sucessfully promoted <b>{user_member.user.first_name or user_id} User can only add admin rights </b>!",
...
ADMIN_PROMOTE_HANDLER = DisableAbleCommandHandler("admin_promote", promote)
