...
PM_START_TEXT = """
`Hey There!` [👩‍💼](https://telegra.ph/file/0ed48df18f4175d61b5d8.jpg) `My name is` *Pikachu Robo*
...
buttons = [
    [
        InlineKeyboardButton(
            text="➕️ ADD GABI TO YOUR GROUP ➕️",url="t.me/PikachuRobo_bot?startgroup=true"),
    ],
    [
        InlineKeyboardButton(
    ...
    [     InlineKeyboardButton(
            text="Fedration logs", url="https://.me/pikachu_fed_log"),
    
    ],
    [
        InlineKeyboardButton(
            text="📮 Update Channel", url="https://t.me/PikachuUpdate"),
    ],
    [
        InlineKeyboardButton(
            text="📑 Loges", url="https://t.me/"),
          


InlineKeyboardButton(
            text="🐱 SUPPORT", url="https://telegram.dog/PikachuGbanSupport"
        ),
...
HELP_STRINGS = """
`Hey there! My name is` [Pikachu Robo]("https://telegra.ph/file/8cab4bb122cf76702b06d.jpg") 
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project via [Paytm](#) or by contacting @PikachuRobo_bot\
...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("PikachuRobo.modules." + module_name)
